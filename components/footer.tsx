...
import useNewsLetter,{ClientData} from "@/hooks/use-news-latter";
...
const Footer = () => {
  ...
  const SocialMedia = [
    {
      name: "LinkedIn",
      link: "https://www.linkedin.com/in/m-sauki-futaki-wahid-b67a7924a/",
    },
    {
      name: "Twitter",
      link: "#",
    ...
    {
      name: "Instagram",
      link: "https://www.instagram.com/saukifutakiii/",
    },
    {
      name: "Github",
  ...
  return (
    <>
      ...
      <div
        className="relative h-full sm:pt-14 pt-8 bg-[#f7f7f7] text-black hidden lg:block md:hidden border-t-4 border-black"
        ref={container}
      >
        <div className="sm:container  px-4 mx-auto">
          ...
          <div className="flex md:flex-row flex-col-reverse gap-3 justify-between py-2">
            <span className="font-medium">
              ...
              &copy; {new Date().getFullYear()} SaukiFutaki. All Rights Reserved.
            </span>
